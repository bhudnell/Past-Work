...
// Rick Mercer change from constants to enums 2010
enum Neighbor {
...
enum Move {
	// THe four available Move values to be returned by method Move getMove( . .
	// .
...
//
// The move should be specified using Move.HOP, Move.LEFT, Move,RIGHT, or
// Move.INFECT.
// The four parameters to getMove specify what neighbors the critter: These
// choices
...
public class AllCritterCode {
	...
	public static void main(String[] args) {
		...
		model.add(50, MyCritter.class);
		model.add(50, Rover.class); // TO BE IMPLEMENTED
		// model.add(50, Food.class); // TO BE IMPLEMENTED
		...
		// Place your new Critter with your own AI into a separate file for
