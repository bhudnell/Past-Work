...
public class LinkedPriorityListTest {
	...
	public void testMoveToLast() {
		PriorityList<String> list = new LinkedPriorityList<String>();
		PriorityList<String> list2 = new LinkedPriorityList<String>();
		for (int i = 0; i < 5; i++) {
			list.insertElementAt(i, "" + i);
			list2.insertElementAt(i, "" + i);
		}
		list.moveToLast(4);
		assertEquals("4", list.getElementAt(4));
		list.moveToLast(0);
		...
		list2.moveToLast(3);
		assertEquals("3", list2.getElementAt(4));
		assertEquals("4", list2.getElementAt(3));
	}
