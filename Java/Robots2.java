 ...
 * buried in the GameState2 class.
 */
...
public class Proj10Robots
{
    public static void main(String[] args)
    {
        ...
        // you clear the board, we start a new game, with more robots.
        int level = 1;
        int safeTeleports = 10;
        ...
        while (true)
        {
            ...
            GameState2 game = new GameState2(board_size);
